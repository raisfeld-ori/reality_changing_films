  ...
  return (
    <div className="w-full bg-white flex items-center justify-center p-4">
      <div className="max-w-4xl w-full text-center">
        ...
        <Link href={'/contact'}
          className="px-8 py-3 bg-blue-600 ml-5 text-white text-lg font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-opacity-50"
        >
          דברו איתנו
        </Link>
